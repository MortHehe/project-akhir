...
@section('content')
    ...
    <div class="card">
        ...
        <form method="POST" action="{{ route('freelancer.settings.update') }}">
            @csrf
            @method('PATCH')
    ...
    <div class="card">
        ...
        <form method="POST" action="{{ route('freelancer.notifications.update') }}">
            @csrf
            @method('PATCH')
            ...
            <div class="toggle-group">
                <div class="toggle-info">
                    ...
                    <p>Receive email updates about your orders and reviews</p>
                </div>
            ...
            <div class="toggle-group">
                <div class="toggle-info">
                    ...
                    <p>Get notified when clients leave you reviews</p>
                </div>
                <label class="toggle-switch">
            ...
            <div class="toggle-group">
                <div class="toggle-info">
                    <h3>💬 New Messages</h3>
                    <p>Receive alerts for new messages from clients</p>
                </div>
                <label class="toggle-switch">
    ...
    <div class="card" style="border: 2px solid #ffebee;">
        ...
        <div class="alert alert-warning">
            <strong>⚠️ Warning:</strong> Deleting your account is permanent and cannot be undone. All your data, orders, earnings, and messages will be permanently lost.
        </div>

        <form method="POST" action="{{ route('freelancer.account.delete') }}" onsubmit="return confirm('⚠️ Are you absolutely sure you want to delete your account?\n\nThis action cannot be undone and you will lose:\n• All your orders and history\n• All your earnings data\n• All your messages\n• All your reviews\n• All your account data\n\nType DELETE to confirm.');">
            @csrf
            @method('DELETE')
