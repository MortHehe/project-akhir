        ...
        <aside class="sidebar">
            ...
            <nav class="menu">
                ...
                <div class="menu-section">
                    ...
                    <a href="{{ route('freelancer.settings') }}" class="menu-item active">
        ...
        <main class="main-content">
            ...
            <div class="settings-card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('freelancer.account.delete') }}" onsubmit="return confirm('Are you sure you want to delete your account? This action cannot be undone.');">
                        @csrf
                        @method('DELETE')
